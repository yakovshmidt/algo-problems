...
public class RemoveNthNodeFromEndOfListTest {
    ...
    public void testRemoveNthFromEnd_2() {
        ...
        ListNode listNodeWithoutSecondNodeFromEndOfList = new RemoveNthNodeFromEndOfList().removeNthFromEnd(listNode, 3);

        assertEquals(1, listNodeWithoutSecondNodeFromEndOfList.val);
        assertEquals(2, listNodeWithoutSecondNodeFromEndOfList.next.val);
        assertEquals(5, listNodeWithoutSecondNodeFromEndOfList.next.next.val);
        assertNull(listNodeWithoutSecondNodeFromEndOfList.next.next.next);
    }
}