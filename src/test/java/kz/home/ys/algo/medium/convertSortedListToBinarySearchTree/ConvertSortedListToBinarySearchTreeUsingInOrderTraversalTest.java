...
public class ConvertSortedListToBinarySearchTreeUsingInOrderTraversalTest extends TestCase {
    ...
    public void testSortedListToBST() {
        ...
        TreeNode actual = new ConvertSortedListToBinarySearchTreeUsingInOrderTraversal().sortedListToBST(
