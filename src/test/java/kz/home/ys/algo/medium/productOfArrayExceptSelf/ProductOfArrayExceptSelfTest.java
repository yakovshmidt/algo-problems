...
public class ProductOfArrayExceptSelfTest {
    ...
    public void testProductExceptSelf() {
        int[] productExceptSelf1 = new ProductOfArrayExceptSelf().productExceptSelf(new int[]{1, 2, 3, 4});
        ...
        int[] productExceptSelf2 = new ProductOfArrayExceptSelf().productExceptSelf(new int[]{-1, 1, 0, -3, 3});
        ...
        int[] productExceptSelf3 = new ProductOfArrayExceptSelf().productExceptSelf(new int[]{1, 0, 1, 0});
