...
public class WordSquaresBacktrackingWithHashTableTest {

    @Test
    public void testWordSquares() {
        List<List<String>> actual = new WordSquaresBacktrackingWithHashTable().wordSquares(new String[]{"abat", "baba", "atan", "atal"});
