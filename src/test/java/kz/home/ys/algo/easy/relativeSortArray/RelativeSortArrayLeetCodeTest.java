...
public class RelativeSortArrayLeetCodeTest extends TestCase {

    public void testRelativeSortArray() {
        int[] expected = new int[]{2, 2, 2, 1, 4, 3, 3, 9, 6, 7, 19};

        int[] actual = new RelativeSortArrayLeetCode().relativeSortArray(new int[]{2, 3, 1, 3, 2, 4, 6, 7, 9, 2, 19}, new int[]{2, 1, 4, 3, 9, 6});
