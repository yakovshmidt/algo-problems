...
public class IntersectionOfTwoLinkedListsUsingHashSetTest {
    ...
    public void testGetIntersectionNode() {
        ...
        ListNode intersectionNode = new IntersectionOfTwoLinkedListsUsingHashSet().getIntersectionNode(nodeA, nodeB);
