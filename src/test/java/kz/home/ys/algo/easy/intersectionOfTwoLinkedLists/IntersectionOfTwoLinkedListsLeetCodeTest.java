...
public class IntersectionOfTwoLinkedListsLeetCodeTest {
    ...
    public void testGetIntersectionNode() {
        ...
        ListNode intersectionNode = new IntersectionOfTwoLinkedListsLeetCode().getIntersectionNode(nodeA, nodeB);
